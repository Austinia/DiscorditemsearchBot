...
export declare type Version = 1 | 2;
export declare type ValueOf<T> = T[keyof T];
export declare type Nullable<T> = T | null;
export declare type WidgetType = "status" | "servers" | "votes";
export declare type WidgetTarget = "bots";
export declare type WidgetStyle = "classic" | "flat";
export declare type WidgetFormat = "webp" | "png" | "jpg" | "jpeg" | "svg";
export interface KoreanbotsClientOptions extends ClientOptions {
    koreanbots: Omit<KoreanbotsOptions, "clientID"> & {
        clientID?: string;
    };
    koreanbotsClient?: {
...
export declare type WidgetMakeOptions = WidgetData & WidgetOptions;
...
export declare type BotStatus = "online" | "idle" | "dnd" | "streaming" | "offline";
export declare type BotState = "ok" | "reported" | "blocked" | "private" | "archived";
export declare type Category = "관리" | "뮤직" | "전적" | "게임" | "도박" | "로깅" | "슬래시 명령어" | "웹 대시보드" | "밈" | "레벨링" | "유틸리티" | "대화" | "NSFW" | "검색" | "학교" | "코로나19" | "번역" | "오버워치" | "리그 오브 레전드" | "배틀그라운드" | "마인크래프트";
export declare type Library = "discord.js" | "Eris" | "discord.py" | "discordcr" | "Nyxx" | "Discord.Net" | "DSharpPlus" | "Nostrum" | "coxir" | "DiscordGo" | "Discord4J" | "Javacord" | "JDA" | "Discordia" | "RestCord" | "Yasmin" | "disco" | "discordrb" | "serenity" | "SwiftDiscord" | "Sword" | "harmony" | "기타" | "비공개";
...
export declare type UserManagerOptions = BotManagerOptions;
export declare type WidgetManagerOptions = BotManagerOptions;
